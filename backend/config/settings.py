"""
إعدادات Django لنظام إدارة المخزون والمحاسبة
Django settings for Store Management ERP System
"""
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Store Management ERP API',
...
# Company Settings
COMPANY_NAME = os.getenv('COMPANY_NAME', 'شركة افتراضية')
